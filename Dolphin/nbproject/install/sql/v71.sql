...
SET @iCatGeneral = 3;
INSERT INTO `sys_options` VALUES
('sys_ftp_login', '', @iCatHidden, 'FTP server login', 'digit', '', '', 1, ''),
('sys_ftp_password', '', @iCatHidden, 'FTP server password', 'digit', '', '', 2, ''),
('sys_ftp_dir', '', @iCatHidden, 'Path to Dolphin on FTP server', 'digit', '', '', 3, ''),
...
('sys_tmp_version', '7.1.4', @iCatHidden, 'Dolphin version ', 'digit', '', '', 10, ''),
